...
* Issue  2126  iPython console rendering of pandas.DataFrame._repr_html_() note in changelog
...
* (Fixes Issue 649) Patch submitted by [DavidAnthonyPowell](http://code.google.com/u/DavidAnthonyPowell/) - Syntax highlighter does not recognise imaginary, binary or octal numbers
...
* (Fixes Issue 546) (Contributor: [Alex Fargus](http://code.google.com/u/alex.fargus/)) C/Cpp syntax highlighting bugfix
